...
export function AdminSidebar() {
  ...
  return (
    <aside className="gcard rounded-2xl p-5 h-fit sticky top-24">
      {/* Brand */}
      <div className="px-2 mb-6 pb-5" style={{ borderBottom: '1px solid rgba(240,232,214,0.06)' }}>
        ...
        <p className="text-[0.65rem] font-body" style={{ color: 'rgba(240,232,214,0.30)' }}>
        ...
        {NAV.map(({ href, label, icon }) => {
          ...
          return (
            <Link key={href} href={href}
              ...
              style={{
                background: active ? 'rgba(194,130,13,0.14)' : 'transparent',
                color:      active ? '#C2820D'               : 'rgba(240,232,214,0.40)',
      ...
      {/* Divider */}
      <div style={{ height: '1px', background: 'rgba(240,232,214,0.06)', marginBottom: '12px' }} />
