    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden grid-bg px-4">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="auth-card text-center">
          ...
          <h1 className="h-lg mb-3" style={{ color: '#F0E8D6' }}>Verify your email</h1>
          <p className="font-body text-sm leading-relaxed mb-2" style={{ color: 'rgba(240,232,214,0.44)' }}>
            We&apos;ve sent a verification link to your email address.
          </p>
          <p className="font-body text-sm leading-relaxed mb-8" style={{ color: 'rgba(240,232,214,0.44)' }}>
