  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#06091A' }}>
      ...
      <aside className={`dash-sidebar fixed lg:static z-40 transition-transform duration-300
        ...
        {/* User */}
        <div className="flex items-center gap-3 px-3 mb-6 pb-5"
          style={{ borderBottom: '1px solid rgba(240,232,214,0.06)' }}>
          ...
          <div className="min-w-0">
            <div className="font-display font-semibold text-sm truncate" style={{ color: '#F0E8D6' }}>{name}</div>
            <div className="text-xs font-body" style={{ color: 'rgba(240,232,214,0.30)' }}>Attendee</div>
          </div>
        </div>
