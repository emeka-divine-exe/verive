    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden grid-bg px-4 py-24">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="auth-card">
          <h1 className="h-lg text-center mb-2" style={{ color: 'var(--v-text)' }}>Welcome back</h1>
          <p className="text-center font-body text-sm mb-8" style={{ color: 'var(--v-muted)' }}>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-xs font-body"
          ...
          <p className="text-center text-sm font-body mt-6" style={{ color: 'var(--v-muted)' }}>
            Don&apos;t have an account?{' '}
            <Link href="/signup" className="font-semibold" style={{ color: 'var(--v-gold)' }}>Sign up</Link>
          </p>
        </div>
