...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden grid-bg px-4 py-24">
      <div className="orb w-96 h-96 -left-32 top-0"          style={{ background: 'rgba(194,130,13,0.10)' }} />
      <div className="orb w-80 h-80 right-0 bottom-0 translate-x-1/3" style={{ background: 'rgba(31,122,104,0.07)' }} />
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="auth-card">
          <h1 className="h-lg text-center mb-2" style={{ color: '#F0E8D6' }}>Welcome back</h1>
          <p className="text-center font-body text-sm mb-8" style={{ color: 'rgba(240,232,214,0.40)' }}>
            Log in to your Verive account
          </p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-xs font-body transition-colors"
                  style={{ color: '#C2820D' }}>
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-sm font-body mt-6" style={{ color: 'rgba(240,232,214,0.36)' }}>
            Don&apos;t have an account?{' '}
            <Link href="/signup" className="font-semibold transition-colors" style={{ color: '#C2820D' }}>
              Sign up
            </Link>
          </p>
        </div>
