...
const PAST = [
  {
    title: 'Lagos Dev Summit 2024',
    date: 'Oct 2024',
    attendees: '850',
  },
  {
    title: 'Google I/O Extended Lagos 2024',
    date: 'May 2024',
    attendees: '1,200',
  },
  {
    title: 'GDG DevFest Lagos 2023',
    date: 'Nov 2023',
    attendees: '1,500',
  },
]
...
export default function OrganizerProfilePage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen">
      {/* Cover */}
      <div
        className={`w-full bg-gradient-to-r ${org.coverColor} relative overflow-hidden mt-[66px]`}
        style={{ height: '260px' }}
      >
        <div
          ...
          style={{
            background:
              'linear-gradient(to top, rgba(13,7,25,0.7) 0%, transparent 60%)',
          }}
        />
      ...
      <div className="container-page">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 -mt-10 mb-10 relative z-10">
          ...
          <div className="flex items-center gap-3 pb-1">
            ...
            <button className="btn-pri text-white font-semibold px-6 py-2.5 text-sm">
              Follow
            </button>
          </div>
        </div>
        ...
        <div className="sr grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
          {[
            ...
            {
              v: org.since.toString(),
              l: 'Member Since',
            },
          ].map(({ v, l }) => (
            <div
              key={l}
              className="gcard rounded-2xl p-5 text-center"
            >
              <div
          ...
          <div className="sr">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {org.categories.map((cat) => (
                <span
                  key={cat}
                  className={`tag ${CATEGORY_META[cat].tagClass}`}
                >
            ...
            <div
              ...
              style={{
                border:
                  '1px solid rgba(123,63,228,0.18)',
              }}
            >
              <p
              ...
              <Link
                href="/apply"
                className="btn-pri text-white text-xs font-semibold px-5 py-2.5 w-full justify-center"
              >
                Apply Now
              </Link>
            </div>
            ...
            <div className="sr">
              ...
              <div className="space-y-3">
                {PAST.map(({ title, date, attendees }) => (
                  <div
                    key={title}
                    className="gcard rounded-2xl p-5 flex items-center gap-5"
                    style={{ opacity: 0.55 }}
                  >
                    <div
                      className="w-14 h-14 rounded-xl flex-shrink-0 ev-img ev-img-tech"
                      style={{ minWidth: '56px' }}
                    />

                    <div className="flex-1 min-w-0">
                      <h3
                        className="font-display font-semibold text-sm truncate mb-1"
                        style={{ color: '#F0EAFF' }}
                      >
                        {title}
                      </h3>
